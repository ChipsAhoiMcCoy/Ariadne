...
internal sealed class AccessiblePlayerActionsMenuState : AccessibleMenuState
{
	...
	private void ToggleCloud()
	{
		...
		catch (Exception exception)
		{
			...
			ModContent.GetInstance<AriadneMod>().Logger.Error("Could not move character save.", exception);
		}
	}
	...
	private void Delete()
	{
		...
		catch (Exception exception)
		{
			...
			ModContent.GetInstance<AriadneMod>().Logger.Error("Could not delete character save.", exception);
		}
	}
}
...
internal sealed class AccessibleWorldActionsMenuState : AccessibleMenuState
{
	...
	private void ToggleCloud()
	{
		...
		catch (Exception exception)
		{
			...
			ModContent.GetInstance<AriadneMod>().Logger.Error("Could not move world save.", exception);
		}
	}
	...
	private void Delete()
	{
		...
		catch (Exception exception)
		{
			...
			ModContent.GetInstance<AriadneMod>().Logger.Error("Could not delete world save.", exception);
		}
	}
}
