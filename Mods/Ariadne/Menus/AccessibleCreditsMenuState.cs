	...
	protected override void BuildEntries(List<AccessibleMenuEntry> entries)
	{
		entries.Add(new(
			...
			() => Announce(
				...
				"Ariadne accessibility support is powered by Prism and its screen-reader backends."),
			description: () => "Press Enter to hear the credit summary."));
		entries.Add(new(
			() => "Third-party notices",
			() => Announce("Ariadne includes Prism under the Mozilla Public License 2.0. Complete notices are included with the mod."),
