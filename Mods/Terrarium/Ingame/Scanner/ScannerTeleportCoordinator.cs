...
internal sealed class ScannerTeleportCoordinator
{
	...
	private const string TeleportContext = "Terrarium.VisibleSurroundingsScanner";
	...
	internal void UpdateVerification()
	{
		...
		{
			_pendingVerification = null;
			TerrariumMod.ScreenReader.Output($"The server rejected or corrected the scanner teleport near {pending.TargetName}.");
			return;
		}
