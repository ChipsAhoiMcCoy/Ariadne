...
/// Installed Terraria PCM is cached and rendered through Terrarium's spatializer;
...
internal sealed class CursorEarconSound : IDisposable
{
	...
	private const string CursorSoundIdentifierPrefix = "Terrarium/CursorEarcon/";
	...
	internal void Play(Point tilePosition, TerrariumClientConfig config)
	{
		StopCurrent();
		if (_disposed ||
	...
	private static bool CanPlay(TerrariumClientConfig config)
	{
